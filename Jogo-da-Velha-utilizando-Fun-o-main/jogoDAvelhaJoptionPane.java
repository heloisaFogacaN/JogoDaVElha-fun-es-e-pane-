...
public class jogoDAvelha {
	...
	static void jogoVelha() {
		JOptionPane.showMessageDialog(null,"["+jogoDAvelha[0][0] +"]" + "[" +jogoDAvelha[0][1] + "]" + "[" +jogoDAvelha[0][2]+"]"
	...
	static public int preencher(int preencheu, int jogador) {
		int i, j;
		while (preencheu != 1) {
			i = Integer.parseInt(JOptionPane.showInputDialog(null, "Jogador " + jogador + ":"+"\nInforme a linha da jogada:"));
			j = Integer.parseInt(JOptionPane.showInputDialog(null, "Informe a coluna da jogada"));
